...
const portfolioItems = [
  {
    ...
    videoURL: process.env.PUBLIC_URL + "/assets/amira_demo.mov",
  ...
  {
    title: "Wander Match",
    videoURL: process.env.PUBLIC_URL + "/assets/wander_match_demo.mp4",
    description: "A flight destination discovery app using the skyscanner and google places apis.",
  },
  {
    title: "Tax Calculator",
    videoURL: process.env.PUBLIC_URL + "/assets/tax_calculator_demo.mov",
  ...
  {
    title: "TripAdvisor",
    imgURL: process.env.PUBLIC_URL + "/assets/TA_screen_shot.png",
  ...
  },
  {
    ...
    imgURL: process.env.PUBLIC_URL + "/assets/github_logo.png",
    linkURL: "https://github.com/klister10",
    description: "Visit my GitHub.",
  },
  {
    title: "Let's Connect",
    imgURL: process.env.PUBLIC_URL + "/assets/linkedin_logo.png",
